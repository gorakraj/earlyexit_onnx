...
class TinyImagenet():
    def __init__(self, batch_size=128):
        ...
        train_dir = '/home/gr719/Downloads/Imperial2021/8.Learning to Stop/l2stop-master/sdn_stop/data/tiny-imagenet-200/train'
        valid_dir = '/home/gr719/Downloads/Imperial2021/8.Learning to Stop/l2stop-master/sdn_stop/data/tiny-imagenet-200/val'
...
def create_val_folder():
    ...
    """
    path = os.path.join('/home/gr719/Downloads/Imperial2021/8.Learning to Stop/l2stop-master/sdn_stop/data/tiny-imagenet-200', 'val/images')  # path where validation data is present now
    filename = os.path.join('/home/gr719/Downloads/Imperial2021/8.Learning to Stop/l2stop-master/sdn_stop/data/tiny-imagenet-200', 'val/val_annotations.txt')  # file where image2class mapping is present
