...
def msd_args():
	...
	exp_group.add_argument('--save_name', type=str, default='save/default-{}'.format(time.time()),metavar='SAVE',
	...
	exp_group.add_argument('--trained_path', type=path_check, metavar='PATH', default=None,
